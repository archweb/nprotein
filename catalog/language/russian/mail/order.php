<?php
// Text
$_['text_new_subject_admin']    = 'Заказ № %s';
$_['text_new_subject']          = '%s - заказ № %s';
$_['text_new_greeting']         = 'Благодарим за интерес к товарам интернет-магазина спортивного питания "%s". Ваш заказ успешно сформирован. Ожидайте звонка менеджера.';
