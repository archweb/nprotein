...
class ModelCheckoutOrder extends Model {	
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			$template->data['link'] = $order_info['store_url'] . 'info&order_id=' . $order_id;
            ...
            if (!$this->model_payment_amazon_checkout->isAmazonOrder($order_info['order_id'])) {
                ...
                if ($order_info['customer_id']) {
                    ...
                    $text .= $order_info['store_url'] . 'info&order_id=' . $order_id . "\n\n";
                }
			...
			if ($this->config->get('config_alert_mail')) {
				$subject = sprintf($language->get('text_new_subject_admin'), $order_id);
		...
		if ($order_info && $order_info['order_status_id']) {
			...
			if ($notify) {
				...
				if ($order_info['customer_id']) {
					...
					$message .= $order_info['store_url'] . 'info&order_id=' . $order_id . "\n\n";
				}
